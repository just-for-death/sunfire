...
class CenterCatalystShimmerIndicator extends StatelessWidget {
  const CenterCatalystShimmerIndicator({super.key, this.value});
  ...
  Widget build(BuildContext context) => Center(
        child: SizedBox(
          ...
          child: const CatalystShimmerIndicator(),
        ),
      );
}

class CatalystShimmerIndicator extends StatelessWidget {
  const CatalystShimmerIndicator({super.key});
