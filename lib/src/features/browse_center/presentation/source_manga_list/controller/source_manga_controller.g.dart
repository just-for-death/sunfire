...
String _$sourceHash() => r'8ec096eef2bea07efd9152c9165375d2d2e1f356';
...
/// See also [source].
class SourceFamily extends Family<AsyncValue<SourceDto?>> {
  /// See also [source].
  const SourceFamily();
...
/// See also [source].
class SourceProvider extends AutoDisposeFutureProvider<SourceDto?> {
  /// See also [source].
  SourceProvider(
    String sourceId,
  ) : this._internal(
  ...
  Override overrideWith(
    FutureOr<SourceDto?> Function(SourceRef provider) create,
  ) {
  ...
  @override
  AutoDisposeFutureProviderElement<SourceDto?> createElement() {
...
mixin SourceRef on AutoDisposeFutureProviderRef<SourceDto?> {
  /// The parameter `sourceId` of this provider.
  String get sourceId;
}

class _SourceProviderElement
    extends AutoDisposeFutureProviderElement<SourceDto?> with SourceRef {
...
String _$baseSourceMangaFilterListHash() =>
    r'76544010d0a48e015d1c572c081536dbea89598e';
