...
String _$sourceListHash() => r'00796a017125de49315075fba6e0b822fc7a1834';

/// See also [sourceList].
@ProviderFor(sourceList)
final sourceListProvider = AutoDisposeFutureProvider<List<SourceDto>?>.internal(
  sourceList,
...
typedef SourceListRef = AutoDisposeFutureProviderRef<List<SourceDto>?>;
String _$sourceMapHash() => r'546737cf1bcf5194f58862bb5e94fc9590aae7dd';

/// See also [sourceMap].
@ProviderFor(sourceMap)
final sourceMapProvider =
    AutoDisposeProvider<AsyncValue<Map<String, List<SourceDto>>>>.internal(
  sourceMap,
...
typedef SourceMapRef
    = AutoDisposeProviderRef<AsyncValue<Map<String, List<SourceDto>>>>;
String _$sourceMapFilteredHash() => r'03b4438f77444134a197b3ea82dccc0f7a395630';
...
typedef SourceMapFilteredRef
    = AutoDisposeProviderRef<AsyncValue<Map<String, List<SourceDto>>?>>;
String _$sourceQueryHash() => r'd72cce9c9c1c91e4ccff68f8e0ebaad368de048f';
...
/// See also [sourceQuery].
class SourceQueryFamily extends Family<List<SourceDto>?> {
  /// See also [sourceQuery].
...
/// See also [sourceQuery].
class SourceQueryProvider extends AutoDisposeProvider<List<SourceDto>?> {
  /// See also [sourceQuery].
  SourceQueryProvider({
    String? query,
  }) : this._internal(
  ...
  Override overrideWith(
    List<SourceDto>? Function(SourceQueryRef provider) create,
  ) {
  ...
  @override
  AutoDisposeProviderElement<List<SourceDto>?> createElement() {
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin SourceQueryRef on AutoDisposeProviderRef<List<SourceDto>?> {
  /// The parameter `query` of this provider.
  String? get query;
}

class _SourceQueryProviderElement
    extends AutoDisposeProviderElement<List<SourceDto>?> with SourceQueryRef {
