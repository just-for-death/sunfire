...
mixin _$QuickSearchResult {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String prefill, String? pattern, String hintText)
        helpText,
    required TResult Function(Fragment$SourceDto source) source,
    required TResult Function(Fragment$SourceDto source, String query)
        sourceSearch,
    required TResult Function(Fragment$CategoryDto category) category,
    required TResult Function(
            Fragment$CategoryDto category, Fragment$MangaDto manga)
        categoryManga,
    required TResult Function(Fragment$CategoryDto? category,
            Fragment$MangaDto manga, Fragment$ChapterDto chapter)
        categoryMangaChapter,
    required TResult Function(
            Fragment$SourceDto? source, Fragment$MangaDto manga)
        manga,
    required TResult Function(Fragment$SourceDto? source,
            Fragment$MangaDto manga, Fragment$ChapterDto chapter)
        chapter,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String prefill, String? pattern, String hintText)?
        helpText,
    TResult? Function(Fragment$SourceDto source)? source,
    TResult? Function(Fragment$SourceDto source, String query)? sourceSearch,
    TResult? Function(Fragment$CategoryDto category)? category,
    TResult? Function(Fragment$CategoryDto category, Fragment$MangaDto manga)?
        categoryManga,
    TResult? Function(Fragment$CategoryDto? category, Fragment$MangaDto manga,
            Fragment$ChapterDto chapter)?
        categoryMangaChapter,
    TResult? Function(Fragment$SourceDto? source, Fragment$MangaDto manga)?
        manga,
    TResult? Function(Fragment$SourceDto? source, Fragment$MangaDto manga,
            Fragment$ChapterDto chapter)?
        chapter,
...
abstract class _$$SourceQuickSearchResultImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Fragment$SourceDto source});
}
...
abstract class SourceQuickSearchResult implements QuickSearchResult {
  const factory SourceQuickSearchResult(
          {required final Fragment$SourceDto source}) =
      _$SourceQuickSearchResultImpl;

  Fragment$SourceDto get source;
...
abstract class _$$SourceSearchQuickSearchResultImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Fragment$SourceDto source, String query});
}
...
abstract class _$$CategoryQuickSearchResultImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Fragment$CategoryDto category});
}
...
abstract class CategoryQuickSearchResult implements QuickSearchResult {
  const factory CategoryQuickSearchResult(
          {required final Fragment$CategoryDto category}) =
      _$CategoryQuickSearchResultImpl;

  Fragment$CategoryDto get category;
...
abstract class _$$CategoryMangaQuickSearchResultImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Fragment$CategoryDto category, Fragment$MangaDto manga});
}
...
abstract class CategoryMangaChapterQuickSearchResult
  ...
  const factory CategoryMangaChapterQuickSearchResult(
          {final Fragment$CategoryDto? category,
          required final Fragment$MangaDto manga,
          required final Fragment$ChapterDto chapter}) =
      _$CategoryMangaChapterQuickSearchResultImpl;

  Fragment$CategoryDto? get category;
  Fragment$MangaDto get manga;
  Fragment$ChapterDto get chapter;
...
abstract class _$$MangaQuickSearchResultImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Fragment$SourceDto? source, Fragment$MangaDto manga});
}
...
abstract class MangaQuickSearchResult implements QuickSearchResult {
  const factory MangaQuickSearchResult(
      {final Fragment$SourceDto? source,
      required final Fragment$MangaDto manga}) = _$MangaQuickSearchResultImpl;
