...
String _$restoreStatusHash() => r'669dbc47aa69fb3ecd2475e6e9d58a329afba389';
...
/// See also [restoreStatus].
class RestoreStatusFamily extends Family<AsyncValue<RestoreStatusDto?>> {
  /// See also [restoreStatus].
...
/// See also [restoreStatus].
class RestoreStatusProvider
    extends AutoDisposeFutureProvider<RestoreStatusDto?> {
  /// See also [restoreStatus].
  ...
  Override overrideWith(
    FutureOr<RestoreStatusDto?> Function(RestoreStatusRef provider) create,
  ) {
  ...
  @override
  AutoDisposeFutureProviderElement<RestoreStatusDto?> createElement() {
...
mixin RestoreStatusRef on AutoDisposeFutureProviderRef<RestoreStatusDto?> {
  /// The parameter `restoreId` of this provider.
  String get restoreId;
}

class _RestoreStatusProviderElement
    extends AutoDisposeFutureProviderElement<RestoreStatusDto?>
