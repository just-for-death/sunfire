...
String _$categoryMangaListHash() => r'c51521c4e7d3041cade0492dcb564a3dbb982cb5';
...
/// See also [categoryMangaList].
class CategoryMangaListFamily extends Family<AsyncValue<List<MangaDto>?>> {
  /// See also [categoryMangaList].
...
class CategoryMangaListProvider
  ...
  Override overrideWith(
    FutureOr<List<MangaDto>?> Function(CategoryMangaListRef provider) create,
  ) {
...
mixin CategoryMangaListRef on AutoDisposeFutureProviderRef<List<MangaDto>?> {
...
String _$libraryDisplayCategoryHash() =>
    r'83b1c4d450114555a8e62b40a9d02a8c48206859';

/// See also [LibraryDisplayCategory].
@ProviderFor(LibraryDisplayCategory)
final libraryDisplayCategoryProvider =
    AutoDisposeNotifierProvider<LibraryDisplayCategory, CategoryDto?>.internal(
...
class CategoryMangaListWithQueryAndFilterProvider
  ...
  @override
  AsyncValue<List<MangaDto>?> runNotifierBuild(
  ...
  AutoDisposeNotifierProviderElement<CategoryMangaListWithQueryAndFilter,
      AsyncValue<List<MangaDto>?>> createElement() {
...
mixin CategoryMangaListWithQueryAndFilterRef
    on AutoDisposeNotifierProviderRef<AsyncValue<List<MangaDto>?>> {
  /// The parameter `categoryId` of this provider.
  int get categoryId;
}
...
class _CategoryMangaListWithQueryAndFilterProviderElement
    extends AutoDisposeNotifierProviderElement<
        CategoryMangaListWithQueryAndFilter, AsyncValue<List<MangaDto>?>>
    with CategoryMangaListWithQueryAndFilterRef {
