...
/// The translations for Gan Chinese, using the Han script (`gan_Hant`).
class AppLocalizationsGanHant extends AppLocalizationsGan {
  AppLocalizationsGanHant() : super('gan_Hant');
}
