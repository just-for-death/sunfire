...
extension SyncMetaQueryFilter
  ...
  QueryBuilder<SyncMeta, SyncMeta, QAfterFilterCondition> valueStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMeta, SyncMeta, QAfterFilterCondition> valueEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncMetaQueryProperty
  ...
  QueryBuilder<SyncMeta, String, QQueryOperations> valueProperty() {
    return QueryBuilder.apply(this, (query) {
