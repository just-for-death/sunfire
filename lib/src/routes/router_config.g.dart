...
RouteBase get $quickSearchRoute => ShellRouteData.$route(
      ...
      routes: [
        ...
        GoRouteData.$route(
          ...
          parentNavigatorKey: MigrationSourceSelectionRoute.$parentNavigatorKey,
          factory: $MigrationSourceSelectionRouteExtension._fromState,
        ),
        GoRouteData.$route(
          path: '/migration/search',
          parentNavigatorKey: MigrationSearchRoute.$parentNavigatorKey,
          factory: $MigrationSearchRouteExtension._fromState,
        ),
        GoRouteData.$route(
          path: '/migration/preview',
          parentNavigatorKey: MigrationPreviewRoute.$parentNavigatorKey,
          factory: $MigrationPreviewRouteExtension._fromState,
        ),
        GoRouteData.$route(
...
extension $SourceTypeRouteExtension on SourceTypeRoute {
  static SourceTypeRoute _fromState(GoRouterState state) => SourceTypeRoute(
        sourceId: state.pathParameters['sourceId']!,
        sourceType: _$Enum$FetchSourceMangaTypeEnumMap
            ._$fromName(state.pathParameters['sourceType']!),
        query: state.uri.queryParameters['query'],
      );

  String get location => GoRouteData.$location(
        '/source/${Uri.encodeComponent(sourceId)}/${Uri.encodeComponent(_$Enum$FetchSourceMangaTypeEnumMap[sourceType]!)}',
        queryParams: {
...
const _$Enum$FetchSourceMangaTypeEnumMap = {
  Enum$FetchSourceMangaType.SEARCH: 's-e-a-r-c-h',
  Enum$FetchSourceMangaType.POPULAR: 'p-o-p-u-l-a-r',
  Enum$FetchSourceMangaType.LATEST: 'l-a-t-e-s-t',
  Enum$FetchSourceMangaType.$unknown: r'$unknown',
};
...
extension $ReaderRouteExtension on ReaderRoute {
  ...
  String get location => GoRouteData.$location(
        '/manga/${Uri.encodeComponent(mangaId.toString())}/chapter/${Uri.encodeComponent(chapterId.toString())}',
        queryParams: {
...
extension $MigrationGlobalSearchRouteExtension on MigrationGlobalSearchRoute {
  static MigrationGlobalSearchRoute _fromState(GoRouterState state) =>
      MigrationGlobalSearchRoute(
        $extra: state.extra as MigrationRouteData?,
      );

  String get location => GoRouteData.$location(
        '/migration/global-search',
      );
...
extension $MigrationSourceSelectionRouteExtension
    on MigrationSourceSelectionRoute {
  static MigrationSourceSelectionRoute _fromState(GoRouterState state) =>
...
extension $MigrationSearchRouteExtension on MigrationSearchRoute {
  static MigrationSearchRoute _fromState(GoRouterState state) =>
...
extension $MigrationPreviewRouteExtension on MigrationPreviewRoute {
  static MigrationPreviewRoute _fromState(GoRouterState state) =>
      MigrationPreviewRoute(
        $extra: state.extra as MigrationPreviewRouteData?,
      );
...
extension $MigrationProgressRouteExtension on MigrationProgressRoute {
  static MigrationProgressRoute _fromState(GoRouterState state) =>
      MigrationProgressRoute(
        $extra: state.extra as MigrationProgressRouteData?,
      );
